...
local user_save = SaveFile.read_native_objects(user_path, {0xdbe3f199, 0x85e904c1}, {"app.savedata.cUserSaveData", "via.storage.saveService.SaveFileDetail"}, steamid, game.MHWILDS)
